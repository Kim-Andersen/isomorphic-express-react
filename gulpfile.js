...
gulp.task('browserifyTask', function () {
  ...
  var appBundler = browserify({
    entries: [path.appDir+'/main.js'], // Only need initial file, browserify finds the rest
...
// gulp.task('htmlTask', ['browserifyTask', 'cssTask'], function(){
//   //var target = gulp.src(path.buildDir + '/index.html');
//   var target = gulp.src('./views/**/*.ejs');
...
gulp.task('deploy', ['cleanTask'], function () {
  ...
  gulp.start('browserifyTask', 'cssTask', 'imagesTask');

});

gulp.task('test', function () {
  return gulp.src(path.buildDir+'/testrunner-phantomjs.html').pipe(jasminePhantomJs());
});